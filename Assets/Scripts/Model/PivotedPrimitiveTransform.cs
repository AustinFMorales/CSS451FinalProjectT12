...
public class PivotedPrimitiveTransform : NodePrimitive
{
    ...
    // as part of scenenode Hierarchy, we have to play an animation in one of our primitives
    // in this code, i inherit 
    
    // NOTE: Reused from Austin's MP4, may have to retool for animation support
